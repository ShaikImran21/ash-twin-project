// Backend Server with SendGrid Email API
// FREE: 100 emails per day - No personal email needed!
...
async function sendEmailWithSendGrid(toEmail, otp) {
    const msg = {
        to: toEmail,
        from: {
            email: 'noreply@voyager-travel.com', // Must be verified in SendGrid
            name: 'Voyager Travel'
        },
...
app.post('/api/send-otp', async (req, res) => {
    try {
        ...
        // Send email via SendGrid
        const emailResult = await sendEmailWithSendGrid(email, otp);
...
app.listen(PORT, () => {
    console.log(`
╔════════════════════════════════════════════════════════╗
║     🚀 VOYAGER SERVER - SENDGRID API                   ║
╠════════════════════════════════════════════════════════╣
║  Server: http://localhost:${PORT}                        ║
║  Email Provider: SendGrid (100 emails/day FREE)        ║
